  ...
  try {
    ...
    const registrations = await db
      .select({
        ...
        phoneCountryCode: eventRegistrations.phone_country_code,
        phoneNumber: eventRegistrations.phone_number,
        phoneCountryAlpha3: eventRegistrations.phone_country_alpha3,
